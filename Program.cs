...
class Program
{
    ...
    public static async Task task1()
    {
        ...
        Console.WriteLine("Subscribe topic: " + "/ABCD/dataa");

        mqttClient.ApplicationMessageReceivedAsync += async e =>
        {
            Console.WriteLine("Topic /ABCD/dataa: " + Encoding.UTF8.GetString(e.ApplicationMessage.PayloadSegment));
        };
    ...
    public static async Task SendDataAsync()
    {
        ...
        while (true)
        {
            ...
            string json = JsonSerializer.Serialize(dataPacket);
